...
class TextureTileDelegateMock: TextureTileDelegate {
    ...
    func textureTileAllocate(regions: Set<TextureTileRegion>, commandBuffer _: SequencialCommandBuffer) {
        actions.append(.allocate(regions: regions))
    }

    func textureTileFree(regions: Set<TextureTileRegion>, commandBuffer _: SequencialCommandBuffer) {
